...
import 'package:flutterpara/DischargedPatient.dart';
                                ...
                                children: [
                                  ...
                                  ButtonTheme(
                                    ...
                                    child: MaterialButton(
                                      onPressed: () => {
                                      Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context) => Discharged()))
                                      },
                                                            ...
                                                            child:  Row(
                                                              children: [
                                                                Container(
                                                                  ...
                                                                  child: Text("Bed",style: TextStyle(
                                                                      fontWeight: FontWeight.bold,
                                                                      color:  Colors.grey
                                                                      ,fontSize: 12
                                                                  ),),
                                                                ...
                                                                Flexible(
                                                                  child: Container(
                                                                    //   width: MediaQuery.of(context).size.width*0.3,
                                                                      ...
                                                                      child: Text("A2-Extensive-Care",style: TextStyle(
                                                                          fontWeight: FontWeight.bold,
                                                                          color: Colors.grey
                                                                        ,fontSize: 12
                                                                      ),)),
                                                              ...
                                                              children: [
                                                                ...
                                                                Flexible(
                                                                  child: Container(
                                                                    //   width: MediaQuery.of(context).size.width*0.3,
                                                                      alignment: Alignment.centerLeft,
                                                                      child: Text("988877711",style: TextStyle(
                                                                          fontWeight: FontWeight.bold,
                                                                          color:  Colors.grey
                                                                          ,fontSize: 12
                                                                      ),)),
                                                              ...
                                                              child:  Row(
                                                                children: [
                                                                  Container(
                                                                    padding: EdgeInsets.only(left: 8,right: 8),
                                                                    width: MediaQuery.of(context).size.width*0.3,
                                                                    child: Text("Charges",style: TextStyle(
                                                                        fontWeight: FontWeight.bold,
                                                                        color: Colors.grey
                                                                    ),),
                                                                  ),
                                                              ...
                                                              child:  Row(
                                                                children: [
                                                                  Container(
                                                                    padding: EdgeInsets.only(left: 8,right: 8),
                                                                    width: MediaQuery.of(context).size.width*0.3,
                                                                    child: Text("Due Payment",style: TextStyle(
                                                                        fontWeight: FontWeight.bold,
                                                                        color: Colors.grey
                                                                        ,fontSize: 12
                                                                    ),),
                                                              ...
                                                              child:  Row(
                                                                children: [
                                                                  Container(
                                                                    padding: EdgeInsets.only(left: 8,right: 8),
                                                                    width: MediaQuery.of(context).size.width*0.3,
                                                                    child: Text("Credit Limit",style: TextStyle(
                                                                        fontWeight: FontWeight.bold,
                                                                        color: Colors.grey
                                                                        ,fontSize: 12
                                                                    ),),
